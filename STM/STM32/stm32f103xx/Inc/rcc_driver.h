...
typedef enum {
	RCC_PLL_MUL_2 = 0b0000, // ×2
	RCC_PLL_MUL_3 = 0b0001, // ×3
	RCC_PLL_MUL_4 = 0b0010, // ×4
	RCC_PLL_MUL_5 = 0b0011, // ×5
	RCC_PLL_MUL_6 = 0b0100, // ×6
	RCC_PLL_MUL_7 = 0b0101, // ×7
	RCC_PLL_MUL_8 = 0b0110, // ×8
	RCC_PLL_MUL_9 = 0b0111, // ×9
	RCC_PLL_MUL_10 = 0b1000, // ×10
	RCC_PLL_MUL_11 = 0b1001, // ×11
	RCC_PLL_MUL_12 = 0b1010, // ×12
	RCC_PLL_MUL_13 = 0b1011, // ×13
	RCC_PLL_MUL_14 = 0b1100, // ×14
	RCC_PLL_MUL_15 = 0b1101  // ×16
} RCC_PLLMul_t;
...
typedef enum {
	RCC_CLK_HSI = 0, RCC_CLK_HSE = 1, RCC_CLK_PLL = 2
} RCC_ClockSource_t;

typedef enum {
	RCC_PLL_SRC_HSI_DIV2 = 0, RCC_PLL_SRC_HSE = 1
} RCC_PLLSource_t;
